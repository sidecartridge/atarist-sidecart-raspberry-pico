...
#define FLOPPYEMUL_RANDOM_TOKEN 0xF000
#define FLOPPYEMUL_BPB_DATA (FLOPPYEMUL_RANDOM_TOKEN + 4)      // random_token + 4 bytes
...
#define FLOPPYEMUL_IMAGE (FLOPPYEMUL_OLD_HDV_MEDIACH + 4)      // old_hdv_mediach + 4 bytes

#define WRITE_UINT32_TO_ADDR(offset, value) (*((uint32_t *)ROM4_START_ADDRESS + offset) = (value))
