...
def binary_to_c_array(input_source, output_file, array_name, endian_format="little"):
    ...
    # Headers include
    content = """#include "include/firmware_floppyemul.h"\n\n"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input",
        default="https://github.com/diegoparrilla/atarist-sidecart-floppy-emulator/releases/download/latest/FLOPPY.BIN",
        help="Input URL or file path",
    )
    args = parser.parse_args()

    array_name = "floppyemulROM"
    output_file = "firmware_floppyemul.c"
